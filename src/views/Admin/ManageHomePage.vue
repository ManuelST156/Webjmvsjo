<template>
    <main>
      ...
      <div class="fullLine">
        ...
        @click="(visibleCarouselDialog = true), (imageCarousel = {}), (direction='Carousel')"
      />
        ...
        <Column style="min-width: 8rem" field="estaActiva" header="Estado Imagen">
                <template #body="slotProps">
                    <div class="fullLine">
                    <Checkbox v-model="slotProps.data.estaActiva" :binary="true" :readonly="true" /> 
                    <span class="ml-2">{{ getStatusImage(slotProps.data.estaActiva) }}</span>
                    </div>
                </template>
            </Column>
          ...
          <Column style="min-width: 4rem">
            <template #body="slotProps">
              <Button
                ...
                id="tableButton"
                class="mr-2"
                @click="editImageCarousel(slotProps.data),(direction='Carousel'),console.log(direction)"
              >
              ...
              <Button
                ...
                id="tableButton"
                class="mr-2"
                @click="() => { direction = 'Carousel'; deleteCarouselDialog(slotProps.data) }"
              >
                <div class="icon-wrapper">
      ...
      <div class="fullLine">
        ...
        @click="(visibleNewsDialog = true), (recentNew = {}),(direction='RecentNew')"
      />
        ...
        <Column style="min-width: 8rem" field="estadoNoticiaReciente" header="Estado Noticia">
                <template #body="slotProps">
                    <div class="fullLine">
                    <Checkbox v-model="slotProps.data.estadoNoticiaReciente" :binary="true" :readonly="true" /> 
                    <span class="ml-2">{{ getStatusImage(slotProps.data.estadoNoticiaReciente) }}</span>
                    </div>
                </template>
            </Column>
          ...
          <Column style="min-width: 4rem">
            <template #body="slotProps">
              ...
              <Button
                ...
                id="tableButton"
                class="mr-2"
                @click="{ direction = 'RecentNew'; deleteCarouselDialog(slotProps.data) }"
              >
                <div class="icon-wrapper">
                  <span class="material-symbols-outlined icon">delete</span>
                </div>
      ...
      <div class="fullLine">
        <DataTable :value="getMessages">
          ...
          ></Column>
        <Column style="min-width: 8rem" field="estadoMensajeInicio" header="Estado Mensaje Inicio">
                <template #body="slotProps">
                    <div class="fullLine">
                    <Checkbox v-model="slotProps.data.estadoMensajeInicio" :binary="true" :readonly="true" /> 
                    <span class="ml-2">{{ getStatusImage(slotProps.data.estadoMensajeInicio) }}</span>
                    </div>
                </template>
            </Column>
          ...
          <Column style="min-width: 4rem">
            <template #body="slotProps">
              ...
              <Button
                ...
                id="tableButton"
                class="mr-2"
                @click="{ direction = 'Message'; deleteCarouselDialog(slotProps.data) }"
              >
                <div class="icon-wrapper">
                  <span class="material-symbols-outlined icon">delete</span>
                </div>
      ...
      <div class="fullLine">
        ...
        <div class="pruebaImg">
            <img v-if="isEditing==true" :src="imageCarousel.imagenUrl" id="imageUpload" />
      ...
      <div class="fullLine">
        ...
        <div class="pruebaImg">
            <img v-if="isEditing==true" :src="recentNew.imagenNoticiaReciente" id="imageUpload" />
            <img v-else src="@/assets/Avatar1.png" id="imageUpload" />
        </div>
      ...
      <div class="fullLine">
          ...
          <div class="fullLineText">
            <FloatLabel class="FloatLabel">
              <Textarea
                ...
                required="true"
                :class="{
                  'p-invalid': submitted && !initialMessage.descripcionMensajeInicio,
                }"
              />
              <label
                for="descriptionMessage"
                :class="{
                  'p-error': submitted && !initialMessage.descripcionMensajeInicio,
                }"
              >
                {{
        ...
        <div class="block">
                <Checkbox v-model="initialMessage.estadoMensajeInicio" :binary="true" />
  ...
  const deleteImage=async ()=>{
    if(direction.value=='Carousel')
  {
    var imageOldName = getCarousel.value.find(element => element.idCarousel === imageCarousel.value.idCarousel);
  ...
  if(direction.value=='RecentNew')
  var imageOldName = getRecentNews.value.find(element => element.idNoticiaReciente === recentNew.value.idNoticiaReciente);
    console.log(imageOldName);
        const deleteStorage= await supabase.storage
            .from("imagesOnPages")
            .remove(imageOldName.codigoImagen);
  ...
  const deleteImageCarousel=async ()=>{
    ...
    await deleteImage();
    const {data:deleteCarousel, error:deleteCarouselError}= await supabase.from("ImagenesCarousel")
      .delete()
...
//Agregar Noticias Recientes
  ...
  const deleteRecentNew=async ()=>{
    ...
    await deleteImage();
    const {data:deleteData, error:deleteDataError}= await supabase.from("NoticiasRecientes")
      .delete()
...
const saveMessage=async()=>{
  ...
  try {
    loading.value=true;
    submitted.value = true;
    const {data:insertMessage, error:messageError}=await supabase.from("MensajesIniciales")
      .upsert(initialMessage.value).select();
...
const deleteMessage=async()=>{
  const {data:deleteData, error:deleteDataError}= await supabase.from("MensajesIniciales")
      .delete()
